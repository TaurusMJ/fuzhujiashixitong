...
#define MODEL_FILE_TRASH    "/userdata/models/drive_classify/driving_detect_v1_inst.wk"
...
static HI_S32 CnnTrashClassifyFlag(const RecogNumInfo items[], HI_S32 itemNum, HI_CHAR* buf, HI_S32 size)
{
    ...
    offset += snprintf_s(buf + offset, size - offset, size - offset - 1, "driving classify: {");
    for (HI_U32 i = 0; i < itemNum; i++) {
        ...
        SAMPLE_PRT("----driving item flag----num:%d, score:%d\n", item->num, score);
        switch (item->num) {
            case 0u:
                trashName = "Safe driving";
                break;
            case 1u:
                trashName = "Right-handed typing";
                break;
            case 2u:
                trashName = "Call with your right hand";
                break;
            case 3u:
                trashName = "Left-handed typing";
                break;
            case 4u:
                trashName = "Call with your left hand";
                break;
            case 5u:
                trashName = "Tune the radio";
                break;
            case 6u:
                trashName = "Drink drinks";
                break;
            case 7u:
                trashName = "Take the things in the back";
                break;
            case 8u:
                trashName = "Finishing hair and makeup";
                break;
            case 9u:
                trashName = "Talking to other passengers";
                break;
